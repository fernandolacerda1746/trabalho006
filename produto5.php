...
<head>
    ...
    <link rel="stylesheet" href="Styles/produto5.css">
...
<body>
    ...
    <section class = 'produto-mostruario-container'>
        <h3 class = 'titulo-produto'><?php echo $produtos[4]['nome'] ?></h3>
        <figure class = 'foto-produto'>
            <img src = '<?php echo $produtos[4]['foto']?>'>
        </figure>
        <h4 class = 'categoria-produto'><b>Categoria:</b> <?php echo $produtos[4]['categoria']?></h4>
        <h4 class = 'preco-produto'><b>Preço:</b> R$ <?php echo $produtos[4]['preco']?></h4>
        <div class = 'descricao-produto'>
            <h4 class = 'descricao-titulo'>Descrição:</h4>
            <p class = 'descricao-texto'>
                <?php echo $produtos[4]['descricao']; ?>
            </p>
        </div>
        <div class = 'link-compra'>
            <a href = 'adcproduto.php?codigo=5'>
